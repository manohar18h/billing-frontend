...
const WorkerStock: React.FC = () => {
  ...
  /* -------------------------------- render ------------------------------------- */
  if (loading) return <p className="px-6 py-10 text-center">Loading workers…</p>;
  if (error) return <p className="px-6 py-10 text-center text-red-600">Could not load workers.</p>;
